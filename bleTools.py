...
#This is where blue (which controls bluetooth on the raspberry pi) in stored
BLUEZ_SERVICE_NAME = "org.bluez"
#The GATT manager is the main manager for services on the pi
...
#The code below is for the terminal to discover the interfaces on our bluetooth module hci0
#gdbus introspect -y -d "org.bluez" -o "/org/bluez/hci0"
#https://github.com/PunchThrough/espresso-ble/blob/master/ble.py#L61

def find_adapter(bus):
    """
    Returns the first object that the bluez service has that has a GattManager1 interface
    Should return org/bluez/hci0
    """
